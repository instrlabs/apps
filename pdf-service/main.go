...
func main() {
	...
	instrProcessor := internal.NewInstructionProcessor(cfg, s3, nats, instrRepo, detailRepo, productClient, pdfSvc)

	_, _ = nats.Subscribe(cfg.NatsSubjectPdfRequests, func(m *natsgo.Msg) {
