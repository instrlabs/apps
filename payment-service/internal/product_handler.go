...
func (h *ProductHandler) Register(app *fiber.App) {
...
// Exported wrappers to allow route registration outside without using Register
func (h *ProductHandler) CreateProduct(c *fiber.Ctx) error { return h.createProduct(c) }
func (h *ProductHandler) ListProducts(c *fiber.Ctx) error  { return h.listProducts(c) }
func (h *ProductHandler) GetProduct(c *fiber.Ctx) error    { return h.getProduct(c) }
func (h *ProductHandler) UpdateProduct(c *fiber.Ctx) error { return h.updateProduct(c) }
func (h *ProductHandler) DeleteProduct(c *fiber.Ctx) error { return h.deleteProduct(c) }
