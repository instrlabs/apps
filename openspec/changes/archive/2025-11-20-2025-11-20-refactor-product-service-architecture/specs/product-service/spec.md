...
## Purpose
Refactor the product-service to follow the same clean, feature-based architecture patterns established in the auth-service, improving maintainability, testability, and consistency across microservices.
